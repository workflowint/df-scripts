ALTER TABLE LinkClnInterviewsToResults add CreatedBy varchar(20) default (suser_sname()),
UpdatedBy varchar(20) default (suser_sname()),
...
go
ALTER TABLE LinkInternalInterviewsToResults add CreatedBy varchar(20) default (suser_sname()),
UpdatedBy varchar(20) default (suser_sname()),
CreatedOn datetime DEFAULT (getutcdate()), UpdatedOn datetime DEFAULT (getutcdate()),
UTCCreatedOn smallint DEFAULT ((1)), UTCUpdatedOn smallint DEFAULT ((1))
go
