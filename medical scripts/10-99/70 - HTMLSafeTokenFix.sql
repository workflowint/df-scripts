...
ALTER PROCEDURE [dbo].[GetHTMLSafeToken] @length int, @token varchar(255) OUTPUT
...
ALTER PROCEDURE [dbo].[GetTimeSheetsCode] @peopleid int, @codetype int, @expiry datetime, @retVal varchar(255) OUTPUT
