...
alter table ResumeJinniConfig
add 	[SendInternalMessage] [bit]
go

update ResumeJinniConfig set SendInternalMessage = 0 where SendInternalMessage is null

alter table ResumeJinniConfig alter column SendInternalMessage bit not null
go

alter table ResumeJinniConfig add default(0) for SendInternalMessage
go